...
var (
	accountDBTypes = map[string]string{`ID`: `character varying`, `AccountID`: `character varying`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `BirthDate`: `date`}
	_              = bytes.MinRead
)
